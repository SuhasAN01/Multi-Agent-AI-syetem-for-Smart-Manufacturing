...
const DynamicCalendar = dynamic(
  ...
  { ssr: false, loading: () => <div>Loading interaction layer...</div> }
);
            ...
            <div className="flex flex-1 gap-4 min-h-0 overflow-hidden">
              ...
              <div className="w-full flex flex-col min-w-[180px]">
                <CardList
                  ...
                  emptyText="No workorders found. Please generate work orders from the Failure Prediction module first."
                ...
                {!workordersLoading && workorders.length === 0 && (
                  <div className="mt-4 flex flex-col items-center gap-2 p-4 border border-dashed border-gray-200 rounded-lg">
                    <p className="text-sm text-gray-500 text-center">Ready to optimize? Start by detecting anomalies.</p>
                    <Button 
